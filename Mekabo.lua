...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " ‹ ميكادۅ ›"
SudosS = {1983379011,1468953218}
Sudos = {sudoid,1983379011,1468953218}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
...
type = 'inline',
data = {
{{text = '‹ 𝖳𝖾𝖠𝗆 Mekabo › . .',url="t.me/PPPPRN"}},
}
}
...
{{text = '‹ تغييࢪ اެسم اެݪبۅٛت ›',data="namebot"},{text =(redis:get(bot_id..":namebot") or "‹ ميكادۅ ›"),data="delnamebot"}},
...
os.execute('rm -rf Mekabo.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/Akieno-sourse/Mekabo/main/Mekabo.lua -o Mekabo.lua')
dofile('Mekabo.lua')  
end
if Text == "UpBot" then
...
{{text = '𝁫 : CoDeR .',url="https://t.me/s_l_3 "},{text = '𝁫 : TwS .',url="https://t.me/s_l_3"}},
{{text = '‹ 𝖳𝖾𝖠𝗆 Mekabo › . .',url="t.me/PPPPRN"}},
}
}
...
os.execute('rm -rf Mekabo.lua')
os.execute('curl -s https://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/uuz02e8tBw@raw.githubusercontent.com/MASLDII/u/main/Mekabo.lua -o Mekabo.lua')
dofile('Mekabo.lua')  
end
end
if text == "تحديث" then
...
if TextMsg == 'التاكات' or TextMsg == 'التاك التلقائي' then
Redis:set(Mekabo.."Mekabo:Tagat"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*𝁫 : تم تفعيل التاك التلقائي *").unLock,"md",true) 
end
if TextMsg == 'التاكات' or TextMsg == 'التاك التلقائي' then
Redis:del(Mekabo.."Mekabo:Tagat"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*𝁫 : تم تعطيل التاك التلقائي *").unLock,"md",true) 
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ تدلل فعلت الثنائي *").by,"md",true)
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ تدلل عطلت الثنائي *").by,"md",true)
end
if text == 'ثنائي' then
...
if msg and Redis:get(Mekabo.."Mekabo:Tagat"..msg_chat_id) then
if not Redis:get(Mekabo..":"..msg.chat_id..":tag") then
...
tagname = tagname:gsub("[[]","")
usr = ""..tagname..""
Redis:setex(Mekabo..":"..msg.chat_id..":tag",30,true)
...
GroupAllRtba = Redis:hgetall(Mekabo..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(Mekabo..':GroupNameUser:groups')
GroupAllRtbaL = {}
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "‹ ميكادۅ ›"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "‹ ميكادۅ ›"),"اني لقميل "..(redis:get(bot_id..":namebot") or "‹ ميكادۅ ›"),(redis:get(bot_id..":namebot") or "‹ ميكادۅ ›").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "‹ ميكادۅ ›") then
...
local UserId_Info = bot.searchPublicChat("s_l_3 ")
if UserId_Info.id then
...
local jobs = {"طيار","محامي","دكتور","خباز","مدير بنك","قلب محمد","مدرس","مبرمج السورس"}
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id," *_ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.." .*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*_ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.." .*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*_ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n"..Banal.."\n"..silental.."\n"..rict..""..sent..""..an.." .*").i,"md",true)  
return false
end
...
keyboard.inline_keyboard = {
{
{text = '‹ ??𝖾𝖠𝗆 Mekabo › .', url="t.me/PPPPRN"}
},
}
local msgg = msg.id/2097152/0.5
...
chat_id=msg.chat_id,
photo="https://t.me/PPPPRN/2",
caption=('*welcome to source Mekabo .\n\n*[𝁫 :  ‹ 𝖳𝖾𝖠𝗆 Mekabo › .](http://t.me/PPPPRN)*\n\n*[𝁫 : inFo Mekabo .](http://t.me/PPPPRN)*\n\n*[𝁫 : MoHmadali .](http://t.me/s_l_3)*\n\n*[𝁫 : Tws Mekabo .](http://t.me/s_l_3)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '𝁫 : Coder .',url="t.me/s_l_3"}}})
})
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
