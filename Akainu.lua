Redis:incrby(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheAkainu.."Akainu:Game:Example"..msg.chat_id) then
if text == Redis:get(TheAkainu.."Akainu:Game:Example"..msg.chat_id) then 
Redis:del(TheAkainu.."Akainu:Game:Example"..msg.chat_id)
Redis:incrby(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheAkainu..'Akainu:Channel:Join')}, },}}
...
if tonumber(TheAkainu) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheAkainu..'Akainu:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheAkainu.."Akainu:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheAkainu.."Akainu:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheAkainu.."Akainu:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheAkainu.."Akainu:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheAkainu) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheAkainu.."Akainu:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheAkainu.."Akainu:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheAkainu.."Akainu:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheAkainu..'Akainu:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ᥀︙' then 
Redis:del(TheAkainu..'Akainu:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheAkainu).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheAkainu..'Akainu:Channel:Join',ChannelUser) 
...
Redis:set(TheAkainu..'Akainu:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheAkainu..'Akainu:Channel:Join')
...
os.execute('rm -rf Akainu.lua')
download('https://raw.githubusercontent.com/rsawfw/S/main/Akainu.lua','Akainu.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheAkainu..'Akainu:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheAkainu..'Akainu:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheAkainu.."Akainu:SendBcBot") 
...
Redis:set(TheAkainu.."Akainu:SendBcBot",true) 
...
Redis:del(TheAkainu.."Akainu:LeftBot") 
...
Redis:set(TheAkainu.."Akainu:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheAkainu.."Akainu:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheAkainu.."Akainu:AddSudosNew"..msg_chat_id)
...
Redis:set(TheAkainu.."Akainu:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheAkainu..'Akainu:ChekBotAdd')  
local UsersBot = Redis:smembers(TheAkainu..'Akainu:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheAkainu..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheAkainu.."Akainu:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheAkainu.."Akainu:Originators:Group"..v)
local Manager = Redis:smembers(TheAkainu.."Akainu:Managers:Group"..v)
local Admin = Redis:smembers(TheAkainu.."Akainu:Addictive:Group"..v)
local Vips = Redis:smembers(TheAkainu.."Akainu:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheAkainu.."Akainu:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheAkainu.."Akainu:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheAkainu.."Akainu:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheAkainu..'Akainu:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheAkainu..'Akainu:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheAkainu..'Akainu:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheAkainu.."Akainu:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheAkainu..'Akainu:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheAkainu..'Akainu:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TheAkainu.."Akainu:ChekBotAdd",msg_chat_id)
Redis:set(TheAkainu.."Akainu:Status:Id"..msg_chat_id,true) ;Redis:set(TheAkainu.."Akainu:Status:Reply"..msg_chat_id,true) ;Redis:set(TheAkainu.."Akainu:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheAkainu.."Akainu:Status:BanId"..msg_chat_id,true) ;Redis:set(TheAkainu.."Akainu:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheAkainu.."Akainu:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheAkainu.."Akainu:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheAkainu.."Akainu:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheAkainu.."Akainu:ChekBotAdd",msg_chat_id) then
Redis:incr(TheAkainu..'Akainu:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheAkainu..'Akainu:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheAkainu.."Akainu:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheAkainu..'Akainu:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheAkainu..'Akainu:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheAkainu.."Akainu:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheAkainu.."Akainu:Set:Id:Group"..msg_chat_id)
if Redis:get(TheAkainu.."Akainu:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheAkainu..'Akainu:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheAkainu..'Akainu:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheAkainu..'Akainu:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheAkainu..'Akainu:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
Redis:set(TheAkainu.."Akainu:Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://t.me/TF2TP"}, },}}
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheAkainu).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheAkainu).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheAkainu.."Akainu:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Developers:Groups",UserId) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheAkainu.."Akainu:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheAkainu.."Akainu:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Developers:Groups",UserId) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheAkainu.."Akainu:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheAkainu.."Akainu:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheAkainu.."Akainu:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheAkainu.."Akainu:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheAkainu.."Akainu:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheAkainu.."Akainu:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheAkainu.."Akainu:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheAkainu.."Akainu:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:BotFree",true) 
...
Redis:set(TheAkainu.."Akainu:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheAkainu.."Akainu1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheAkainu.."Akainu1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheAkainu.."Akainu1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheAkainu..'Akainu1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheAkainu..'Akainu1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheAkainu..'Akainu1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheAkainu.."Akainu1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheAkainu.."Akainu1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheAkainu.."Akainu1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheAkainu.."Akainu1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheAkainu.."Akainu1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheAkainu.."Akainu1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheAkainu.."Akainu1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheAkainu.."Akainu1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheAkainu.."Akainu1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheAkainu.."Akainu1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheAkainu.."Akainu1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheAkainu.."Akainu1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheAkainu.."Akainu1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheAkainu.."Akainu1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheAkainu.."Akainu1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheAkainu.."Akainu11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheAkainu.."Akainu11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheAkainu.."Akainu11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheAkainu..'Akainu11:Add:Rd:Sudo:Text'..text)
Redis:del(TheAkainu..'Akainu11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheAkainu..'Akainu11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheAkainu.."Akainu11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheAkainu.."Akainu11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheAkainu.."Akainu11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheAkainu.."Akainu11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheAkainu.."Akainu11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheAkainu.."Akainu11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheAkainu.."Akainu11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheAkainu.."Akainu11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheAkainu.."Akainu11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheAkainu.."Akainu11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheAkainu.."Akainu11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheAkainu.."Akainu11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheAkainu.."Akainu11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheAkainu.."Akainu11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheAkainu.."Akainu11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheAkainu.."Akainu11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheAkainu.."Akainu:allM"..msg.chat_id, msg.id)
if Redis:get(TheAkainu.."Akainu:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheAkainu.."Akainu:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheAkainu.."Akainu:allM"..msg.chat_id)
...
Redis:del(TheAkainu.."Akainu:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheAkainu.."Akainu:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheAkainu.."Akainu:allM"..msg.chat_id)  
...
Redis:del(TheAkainu.."Akainu:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheAkainu.."Akainu:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheAkainu.."Akainu:Status:yt"..msg.chat_id)
...
Redis:set(TheAkainu.."Akainu:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheAkainu.."Akainu:Status:yt"..msg.chat_id) then
local Ttext = text:match('^بحث (.*)$') 
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
local httpsCurl = "https://api-jack.ml/api18.php?token="..Token.."&msg="..MSGID.."&Text="..URL.escape(Ttext).."&chat_id="..msg_chat_id.."&user="..msg.sender.user_id
...
if TextMsg == 'الرابط' then
Redis:del(TheAkainu.."Akainu:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheAkainu.."Akainu:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Status:Id"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Status:Reply"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Status:BanId"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:BotFree") 
...
Redis:del(TheAkainu.."Akainu:TwaslBot") 
...
if Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheAkainu.."Akainu:BanAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/TF2TP'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheAkainu.."Akainu:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheAkainu.."Akainu:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheAkainu.."Akainu:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheAkainu.."Akainu:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheAkainu.."Akainu:BanAll:Groups",UserId) 
...
if not Redis:sismember(TheAkainu.."Akainu:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:BanAll:Groups",UserId) 
...
if Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheAkainu.."Akainu:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
{
{text = '❲ ‹ - 𝗔𝗖𝗔𝗜𝗡𝗢 ⁦. › ❳', url = "https://t.me/TF2TP"}
},
}
...
if not msg.ControllerBot and not Redis:set(TheAkainu.."Akainu:LeftBot") then
...
Redis:set(TheAkainu.."Akainu:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheAkainu.."Akainu:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheAkainu.."Akainu:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheAkainu.."Akainu:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheAkainu.."Akainu:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheAkainu.."Akainu:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheAkainu.."Akainu:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheAkainu..'Akainu:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheAkainu.."Akainu:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:Lock:text"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:Lock:Join"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:lockpin"..msg_chat_id)  
...
Redis:del(TheAkainu.."Akainu:Lock:edit"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheAkainu..'Akainu:'..lock..msg_chat_id)    
end
...
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheAkainu.."Akainu:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheAkainu.."Akainu:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Link"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Video"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:geam"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:vico"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:forward"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Document"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheAkainu.."Akainu:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheAkainu.."Akainu:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheAkainu.."Akainu:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheAkainu.."Akainu:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheAkainu.."Akainu:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheAkainu.."Akainu:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheAkainu.."Akainu:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheAkainu.."Akainu:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheAkainu.."Akainu:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheAkainu.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheAkainu.."Akainu:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheAkainu.."Akainu:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheAkainu.."Akainu:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheAkainu.."Akainu:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheAkainu.."Akainu:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheAkainu.."Akainu:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheAkainu.."Akainu:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheAkainu.."Akainu:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheAkainu.."Akainu:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheAkainu.."Akainu:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheAkainu.."Akainu:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheAkainu..'Akainu:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheAkainu..'Akainu:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheAkainu.."Akainu:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheAkainu.."Akainu:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheAkainu.."Akainu:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheAkainu.."Akainu:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheAkainu.."Akainu:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheAkainu.."Akainu:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/TF2TP'}, 
},
}
}
...
data = {
{
{text = '- ارسال الويب : '..web, data = msg.senderط.user_id..'/web'}, 
},
{
...
Rink = 1
elseif Redis:sismember(TheAkainu.."Akainu:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheAkainu.."Akainu:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheAkainu.."Akainu:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheAkainu.."Akainu:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheAkainu..'Akainu:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheAkainu..'Akainu:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheAkainu..'Akainu:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheAkainu..'Akainu:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheAkainu..'Akainu:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheAkainu.."Akainu:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheAkainu.."Akainu:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(TheAkainu.."Akainu:Set:Id:Groups")
...
Redis:setex(TheAkainu.."Akainu:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
᥀︙`#username` » اسم المستخدم
...
Redis:del(TheAkainu.."Akainu:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheAkainu.."Akainu:DevelopersQ:Groups") 
...
Redis:del(TheAkainu.."Akainu:Developers:Groups") 
...
Redis:del(TheAkainu.."Akainu:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Originators:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Managers:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:BanAll:Groups") 
...
Redis:del(TheAkainu.."Akainu:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheAkainu.."Akainu:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheAkainu.."Akainu:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheAkainu.."Akainu:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheAkainu.."Akainu:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ᥀︙"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheAkainu.."Akainu:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheAkainu.."Akainu:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheAkainu.."Akainu:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:vico"..v)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:Text"..v)   
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:Photo"..v)
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:Video"..v)
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:File"..v)
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:Audio"..v)
Redis:del(TheAkainu.."Akainu:Add:Rd:Sudo:video_note"..v)
Redis:del(TheAkainu.."Akainu:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:File"..v) then
db = "ملف ᥀︙"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheAkainu.."Akainu:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheAkainu.."Akainu:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheAkainu.."Akainu:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheAkainu.."Akainu:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheAkainu.."Akainu:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheAkainu.."Akainu:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheAkainu.."Akainu:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheAkainu.."Akainu:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheAkainu..'Akainu:GetTexting:DevTheAkainu'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheAkainu..'Akainu:Texting:DevTheAkainu')
...
local UserId_Info = LuaTele.searchPublicChat("K_S_K6")
...
if photo.total_count > 0 then
local TestText = "  ❲ 𝘚𝘰𝘶𝘳𝘤𝘦 Akainu ❳\n— — — — — — — — —\n ᥀︙*Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n᥀︙*Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝘚𝘰𝘶𝘳𝘤𝘦 Akainu ❳', url = "https://t.me/TF2TP"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ ᗪEᐯ ❳', url = "https://t.me/K_S_K6"}
},
{
{text = '❲ 𝘚𝘰𝘶𝘳𝘤𝘦 Akainu ❳', url = "https://t.me/TF2TP"},
},
...
if not Redis:get(TheAkainu.."Akainu:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheAkainu.."Akainu:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheAkainu.."Akainu:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
{
{text = '˛ 𝘚𝘰𝘶𝘳𝘤𝘦 Akainu .', url = 't.me/TF2TP'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/TF2TP'}, 
},
{
{text = 'Developer Source !', url = 't.me/ST1_J'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if not Redis:get(TheAkainu.."Akainu:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(TheAkainu.."Akainu:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheAkainu.."Akainu:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheAkainu.."Akainu:Name:Bot") or "اكاينو") then
local NamesBot = (Redis:get(TheAkainu.."Akainu:Name:Bot") or "اكاينو")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات اكاينو بعدين اجاوبك",
...
x = x + 1
Redis:srem(TheAkainu..'Akainu:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheAkainu)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheAkainu..'Akainu:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheAkainu..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheAkainu..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheAkainu..'Akainu:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheAkainu.."Akainu:Game:Smile"..msg.chat_id,SM)
...
local bank_users = Redis:smembers(TheAkainu.."zrfffidtf")
...
local mony = Redis:get(TheAkainu.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TheAkainu..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(TheAkainu.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheAkainu.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(TheAkainu.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheAkainu.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheAkainu..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TheAkainu..':toob:Name:'..zwga_id)
fnte = Redis:get(TheAkainu..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(TheAkainu) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(TheAkainu..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(TheAkainu..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TheAkainu..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TheAkainu..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TheAkainu..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TheAkainu..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TheAkainu..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TheAkainu.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TheAkainu.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TheAkainu.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheAkainu..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(TheAkainu..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TheAkainu..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دينار ","md")
end
if Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheAkainu..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TheAkainu..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(TheAkainu..':toob:Name:'..zoog2)
...
if Redis:sismember(TheAkainu.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(TheAkainu.."noolb"..yemsg.sender.user_id)
gg = Redis:get(TheAkainu.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(TheAkainu.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(TheAkainu.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(TheAkainu.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TheAkainu.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TheAkainu.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TheAkainu.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TheAkainu.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TheAkainu.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TheAkainu.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TheAkainu..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TheAkainu..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TheAkainu..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TheAkainu..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TheAkainu..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دينار","md")
end
if text == "طلاق"  then
if not Redis:get(TheAkainu..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(TheAkainu.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheAkainu.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "بنك اكاينو" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
else
...
gg = "فيزا"
flossst = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheAkainu.."nonna"..msg.sender.user_id,news)
Redis:set(TheAkainu.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheAkainu.."nnonb"..msg.sender.user_id,text)
Redis:set(TheAkainu.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheAkainu.."nonallname"..creditcc,news)
Redis:set(TheAkainu.."nonallbalc"..creditcc,balas)
Redis:set(TheAkainu.."nonallcc"..creditcc,creditcc)
Redis:set(TheAkainu.."nonallban"..creditcc,text)
Redis:set(TheAkainu.."nonallid"..creditcc,banid)
Redis:sadd(TheAkainu.."noooybgy",msg.sender.user_id)
Redis:del(TheAkainu.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
LuaTele.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ( بنك اكاينو . 💳 )  \n\n• رقم حسابك ↢ ( `"..creditcc.."` )\n• نوع البطاقة ↢ ( "..gg.." )\n• فلوسك ↢ ( `"..flossst.."` دينار 💸 )  ","md",true)  
end 
...
local banid = msg.sender.user_id
Redis:set(TheAkainu.."nonna"..msg.sender.user_id,news)
Redis:set(TheAkainu.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheAkainu.."nnonb"..msg.sender.user_id,text)
Redis:set(TheAkainu.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheAkainu.."nonallname"..creditvi,news)
Redis:set(TheAkainu.."nonallbalc"..creditvi,balas)
Redis:set(TheAkainu.."nonallcc"..creditvi,creditvi)
Redis:set(TheAkainu.."nonallban"..creditvi,text)
Redis:set(TheAkainu.."nonallid"..creditvi,banid)
Redis:sadd(TheAkainu.."noooybgy",msg.sender.user_id)
Redis:del(TheAkainu.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheAkainu.."nonna"..msg.sender.user_id,news)
Redis:set(TheAkainu.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheAkainu.."nnonb"..msg.sender.user_id,text)
Redis:set(TheAkainu.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheAkainu.."nonallname"..creditex,news)
Redis:set(TheAkainu.."nonallbalc"..creditex,balas)
Redis:set(TheAkainu.."nonallcc"..creditex,creditex)
Redis:set(TheAkainu.."nonallban"..creditex,text)
Redis:set(TheAkainu.."nonallid"..creditex,banid)
Redis:sadd(TheAkainu.."noooybgy",msg.sender.user_id)
Redis:del(TheAkainu.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
Redis:srem(TheAkainu.."noooybgy", msg.sender.user_id)
Redis:del(TheAkainu.."noolb"..msg.sender.user_id)
Redis:del(TheAkainu.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheAkainu.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TheAkainu.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TheAkainu.."nool:flotysb"..v)
Redis:del(TheAkainu.."zrffdcf"..v)
Redis:del(TheAkainu.."innoo"..v)
Redis:del(TheAkainu.."nnooooo"..v)
Redis:del(TheAkainu.."nnoooo"..v)
Redis:del(TheAkainu.."nnooo"..v)
Redis:del(TheAkainu.."nnoo"..v)
Redis:del(TheAkainu.."polic"..v)
Redis:del(TheAkainu.."ashmvm"..v)
Redis:del(TheAkainu.."hrame"..v)
Redis:del(TheAkainu.."test:mmtlkat6"..v)
Redis:del(TheAkainu.."zahbmm2"..v)
end
Redis:del(TheAkainu.."ttpppi")
...
ballanceed = Redis:get(TheAkainu.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheAkainu.."noolb"..msg.sender.user_id)
gg = Redis:get(TheAkainu.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheAkainu.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheAkainu.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دينار 💸 )\n• الزرف ( "..pppp.." دينار 💸 )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(TheAkainu.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TheAkainu.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheAkainu.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(TheAkainu.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheAkainu.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
Redis:setex(TheAkainu.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheAkainu.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(TheAkainu.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheAkainu.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheAkainu.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('TheAkainu:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('TheAkainu:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('TheAkainu:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('TheAkainu:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(TheAkainu.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheAkainu.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheAkainu.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(TheAkainu.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheAkainu.."noolb"..msg.sender.user_id)
gg = Redis:get(TheAkainu.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheAkainu.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheAkainu.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheAkainu.."transn" .. msg.sender.user_id)
...
if Redis:get(TheAkainu.."nonallcc"..text) then
local UserNamey = Redis:get(TheAkainu.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TheAkainu.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TheAkainu.."nnonb"..fsvhhh)
nouu = Redis:get(TheAkainu.."nnonbn"..fsvhhh)
...
if Redis:get(TheAkainu.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(TheAkainu.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(TheAkainu.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(TheAkainu.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(TheAkainu.."polici" .. msg.sender.user_id,600, true)
Redis:setex(TheAkainu.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(TheAkainu.."nool:flotysb"..bl) or 0
Redis:decrby(TheAkainu.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
if Redis:get(TheAkainu.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheAkainu.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دينار 💸","md",true)
end
local jjjo = "5000"
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دينار 💸","md",true)
Redis:setex(TheAkainu.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text == "علش" or text == "بوت" then
txtBot = {
"شكوو🥺"
,"بيه كرونا 🥺"
,"اهوو هم انت 😒"
}
LuaTele.sendText(msg.chat_id,msg.id,txtBot[math.random(#txtBot)],"md",true)
end
...
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
if Redis:get(TheAkainu.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheAkainu.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
...
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دينار 💸","md",true)
Redis:setex(TheAkainu.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheAkainu.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TheAkainu.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دينار ??","md",true)
else
...
if Redis:get(TheAkainu.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheAkainu.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(TheAkainu.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(TheAkainu.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(TheAkainu.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(TheAkainu.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(TheAkainu.."ttpppi",msg.sender.user_id)
Redis:setex(TheAkainu.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(TheAkainu.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(TheAkainu.."zrfffidtf",msg.sender.user_id)
Redis:setex(TheAkainu.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(TheAkainu.."noooybgy",msg.sender.user_id) then
if Redis:get(TheAkainu.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheAkainu.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
K = 'محظوظ 2x' 
F = '15000'
Redis:incrby(TheAkainu.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(TheAkainu.."nool:flotysb"..msg.sender.user_id) or 0
local teex = 
Redis:setex(TheAkainu.."innoo" .. msg.sender.user_id,600, true)
...
Redis:set(TheAkainu.."Akainu:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheAkainu.."Akainu:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheAkainu.."Akainu:Status:Games"..msg.chat_id) then
Redis:del(TheAkainu.."Akainu:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheAkainu.."Akainu:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheAkainu.."Akainu:Status:Games"..msg.chat_id) then
Redis:del(TheAkainu.."Akainu:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheAkainu.."Akainu:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheAkainu.."Akainu:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheAkainu.."Akainu:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheAkainu.."Akainu:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheAkainu.."Akainu:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheAkainu.."Akainu:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheAkainu.."Akainu:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheAkainu.."Akainu:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheAkainu..'Akainu:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheAkainu.."Akainu:Start:Bot") then
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheAkainu.."Akainu:Name:Bot") or "اكاينو")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/TF2TP'},{text = '᥀ لتنصيب بوت .', url = 't.me/ST1_J'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheAkainu.."Akainu:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheAkainu.."Akainu:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheAkainu.."Akainu:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheAkainu.."Akainu:TwaslBot") and not Redis:sismember(TheAkainu.."Akainu:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheAkainu.."Akainu:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheAkainu.."Akainu:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheAkainu..'Akainu:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheAkainu..'Akainu:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheAkainu.."Akainu:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheAkainu..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheAkainu.."Akainu:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheAkainu.."Akainu:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheAkainu then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheAkainu..'Akainu:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheAkainu.."Akainu:Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheAkainu.."Akainu:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheAkainu.."Akainu:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheAkainu.."Akainu:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheAkainu.."Akainu1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheAkainu.."Akainu:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheAkainu.."Akainu:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheAkainu.."Akainu:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheAkainu.."Akainu1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheAkainu.."Akainu:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheAkainu.."Akainu:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
local ban = LuaTele.getUser(IdUser)
if photo.total_count > 1 then
local ban_ns = '??𝚎𝚛𝚎 𝚊𝚛𝚎 𝚢𝚘𝚞𝚛 𝚙𝚑𝚘𝚝𝚘𝚜'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- اخفاء الامر ', callback_data =IdUser..'/delAmr'}, 
...
Redis:incrby(TheAkainu.."Akainu:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheAkainu.."Akainu:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheAkainu.."Akainu:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheAkainu.."Akainu:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheAkainu.."Akainu:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheAkainu.."Akainu:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheAkainu..'Akainu:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheAkainu.."Akainu:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheAkainu.."Akainu:SilentGroup:Group"..ChatId) 
